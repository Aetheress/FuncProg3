 ...
 */
infix fun Set.union(set: Set): Set = {this(it) or set.contains(it)}

/**
 * Intersection of the two sets
 */
infix fun Set.intersect(set: Set): Set = {this(it) and set.contains(it)}

/**
 * Difference of two given sets
 */
infix fun Set.diff(set: Set): Set = {this(it) xor set.contains(it)}
